...
- ## Diagram
<img src="./image/EmergencyResponse_diagram.png" width="60%" height="60%">

- ## Prototype
<img src="./image/구상도.png" width="60%" height="60%">
...
**- Commit은 최대한 구체적으로 적기** <br>
**- 폰트꺠짐을 방지하기 위해 왠만하면 영어 문자 사용** <br>
**- 변수명은 최대한 기능을 알아볼 수 있도록 선언** <br>
